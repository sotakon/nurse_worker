...
ActiveRecord::Schema.define(version: 2021_03_29_012805) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["rumor_id"], name: "index_comments_on_rumor_id"
  end
  ...
  create_table "corporations_favorites", force: :cascade do |t|
  ...
  create_table "labellings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["job_id"], name: "index_labellings_on_job_id"
  ...
  add_foreign_key "comments", "rumors"
  add_foreign_key "jobs", "corporations"
  add_foreign_key "labellings", "jobs"
